...
Final consideration: this model works best under clause interval  $\tau=1$ (fast information decay makes a node's position more important), so if we stick to that, it's one less parameter to keep in mind.
