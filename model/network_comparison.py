...
graphfiles = [
    ...
    #"data/1_copy.xml", 
    #"data/RESIDENCE_HALLnetwork_copy.xml",
    #"data/DolphinNetwork_copy.xml",
...
network_names = {
    ...
    #"1_copy.xml": "School Friendship",
    #"RESIDENCE_HALLnetwork_copy.xml": "ANU Residence Hall",
    #"DolphinNetwork_copy.xml": "Dolphin Network",
...
if __name__ == '__main__':
    ...
    # Save plots
    print("Saving plots...")
    fig.savefig("output/50_new_newmodel_network_comparison_01_10_2000.png", dpi=300, bbox_inches='tight')
    fig.savefig("output/50_new_newmodel_network_comparison_01_10_2000.pdf",  bbox_inches='tight')
    ...
    # Save data
    df.to_csv("output/50_new_newmodel_network_simulation_results__01_10_2000.csv", index=False)

#df=pd.read_csv("output/new_newmodel_network_simulation_results__01_500.csv")
...
fig.savefig("output/50_nature_newmodel_network_comparison_all_01_10_2000.png", dpi=300, bbox_inches='tight')
fig.savefig("output/50_nature_newmodel_network_comparison_all_01_10_2000.pdf", dpi=300, bbox_inches='tight')
